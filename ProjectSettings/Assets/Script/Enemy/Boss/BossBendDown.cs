...
public class BossBendDown : StateMachineBehaviour
{
    Rigidbody2D rb;
     ...
     void OutbreakAttack()
    {
        ...
        {
            Vector2 _newPos = Vector2.MoveTowards(rb.position, Boss.Instance.moveToPosition, Boss.Instance.speed * 1.5f * Time.fixedDeltaTime);
